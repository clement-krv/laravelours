...
@section('content')
    ...
    <div class="max-w-lg mx-auto p-4">
        ...
        <form action="{{ route('articles.store') }}" method="post" class="bg-white shadow-md rounded p-4" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
                <label for="title" class="block text-gray-700 text-sm font-bold mb-2">Titre</label>
                <input type="text" name="title" value="{{ old('title') }}" id="title" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                @error('title')
